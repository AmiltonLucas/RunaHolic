...
import Women3 from "../../assets/sobre/women3.jpg";
...
function Sobre() {
  ...
  const shuffleImages = () => {
    const shuffled = [...imagesArray].sort(() => Math.random() - 0.5);
    setImages(shuffled);
  };

  useEffect(() => {
    // Chama a função para embaralhar as imagens ao montar o componente
    shuffleImages();
