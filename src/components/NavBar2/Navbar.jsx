            ...
            <div className="flex h-16 items-center">
                ...
                <div className="flex h-full space-x-8">
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800 dark:text-gray-100 dark:hover:text-gray-300"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a
                    href="#"
                    className="text-sm font-medium text-gray-700 hover:text-gray-800 dark:text-gray-100 dark:hover:text-gray-300"
                  >
                    Sign in
                  </a>
                ...
                <div className="flex lg:ml-6">
                  <a
                    href="#"
                    className="p-2 text-gray-400 hover:text-gray-500 dark:text-gray-100 dark:hover:text-gray-300"
                  >
                ...
                <div>
                  ...
                  <div className="ml-4 flow-root lg:ml-6">
                    ...
                    >
                      <ShoppingBagIcon
                        aria-hidden="true"
                        className="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500 dark:text-gray-100"
                      />
                      <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800 dark:text-gray-100">
                        0
                      </span>
